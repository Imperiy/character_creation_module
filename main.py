...
def start_training(character):
    ...
    """
    classes = {
        'Warrior': (f'{char_class.name}, ты Воитель — великий мастер ближнего боя.'),
        'Mage': (f'{char_class.name}, ты Маг — превосходный укротитель стихий.'),
        'Healer': (f'{char_class.name}, ты Лекарь — чародей, способный исцелять раны.')
    }
    print(classes[character.__class__.__name__])
